...
config :groupchat, GroupchatWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: GroupchatWeb.ErrorHTML, json: GroupchatWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Groupchat.PubSub,
  live_view: [signing_salt: "wySM5r0X"]
...
config :groupchat, Groupchat.Mailer, adapter: Swoosh.Adapters.Local
